Program ims_scfi
    ...
    Integer   :: NPROCS, MYRANK, PRINTRANK, LENSFC
...
!   
    ...
    Data LENSFC/18360/
    DATA IY,IM,ID,IH/2019,12,15,18/
    ...
    PRINT*,"STARTING IMS fSCA on RANK ", MYRANK
    ...
    Call get_ims_depth_scf(MYRANK, PRINTRANK, IDIM, JDIM, IY, IM, ID, IH, IVEGSRC, &
            num_subgrd_ims_cels, IMS_SNOWCOVER_PATH, IMS_INDEXES_PATH, & 
    ...
    out_file = TRIM(output_path)// &
               "IMSscf."//TRIM(y_str)//TRIM(m_str)//TRIM(d_str)//".C"//TRIM(fvs_tile)//".nc"	
...
subroutine get_ims_depth_scf(MYRANK, PRINTRANK, IDIM, JDIM, IY, IM, ID, IH, &
    ...
    INTEGER, intent(in)    :: MYRANK, PRINTRANK, IDIM, JDIM, &  
                              IY, IM, ID, IH, IVEGSRC
